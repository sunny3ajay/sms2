...
from .forms import PostForm, MarksForm  # Assuming PostForm is in faculty.forms
...
def post_marks(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            from_email = 'ajayradha9989@gmail.com'
            recipient_list = [user_email]
            send_mail(subject, message, from_email, recipient_list,timeout=30)
